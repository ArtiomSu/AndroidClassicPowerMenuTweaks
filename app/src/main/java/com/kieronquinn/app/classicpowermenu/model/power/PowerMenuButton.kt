...
enum class PowerMenuButtonId {
    EMERGENCY, POWER_OFF, REBOOT, LOCKDOWN, SCREENSHOT, REBOOT_RECOVERY, REBOOT_BOOTLOADER, RESTART_SYSTEMUI, REBOOT_FASTBOOTD, REBOOT_DOWNLOAD, NFC, FLASH_LIGHT;

    companion object {
        val DEFAULT = listOf(POWER_OFF, REBOOT, REBOOT_BOOTLOADER, REBOOT_RECOVERY, RESTART_SYSTEMUI, NFC, FLASH_LIGHT, SCREENSHOT)
    }
}